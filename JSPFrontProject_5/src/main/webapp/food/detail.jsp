...
<div class="container">
	...
	<table class="table">
		<tr>
			<td width="40%" class="text-center" rowspan="8">
				<img src="${vo.poster }" style="width: 330px; object-fit: cover">
			</td>
			<td colspan="2">
				<h3>${vo.name }&nbsp;<span style="color: ${vo.score>3.4?'red':'blue'}">${vo.score }</span></h3>
			</td>
		</tr>
		<tr>
			<th width="10%" style="color: gray" class="info">카테고리</th>
			<td width="50%">${vo.type }</td>
		</tr>
		<tr>
			<th width="10%" style="color: gray" class="info">전화번호</th>
			<td width="50%">${vo.phone }</td>
		</tr>
		<tr>
			<th width="10%" style="color: gray" class="info">주소</th>
			<td width="50%">${vo.address }</td>
		</tr>
		<tr>
			<th width="10%" style="color: gray" class="info">주차</th>
			<td width="50%">${vo.parking }</td>
		</tr>
		<tr>
			<th width="10%" style="color: gray" class="info">영업시간</th>
			<td width="50%">${vo.time }</td>
		</tr>
		<tr>
			<th width="10%" style="color: gray" class="info">테마</th>
			<td width="50%">${vo.theme }</td>
		</tr>
		<tr>
			<th width="10%" style="color: gray" class="info">가격</th>
	...
	<script type="text/javascript" src="//dapi.kakao.com/v2/maps/sdk.js?appkey=API주소입력&libraries=services"></script>
<script>
// 마커를 담을 배열입니다
var markers = [];
