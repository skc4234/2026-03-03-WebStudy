		...
		<table class="table">
			...
			<tr>
				<td width="30%" class="text-center" rowspan="9">
					<img src="${vo.poster }" style="width: 300px; height: 300px; object-fit:cover;">
				</td>
				<td colspan="2">
					<h3>${vo.name }&nbsp;<span style=${vo.score>=3.5?"color:red":"color:blue" }>${vo.score>0?vo.score:"( - ) " }</span></h3>
				</td>
			</tr>
			<tr>
				<td width="10%" class="text-center" style="color:gray">음식종류</td>
				<td width="60%">${vo.type }</td>
			</tr>
			<tr>
				<td width="10%" class="text-center" style="color:gray">전화번호</td>
				<td width="60%">${vo.phone }</td>
			</tr>
			<tr>
				<td width="10%" class="text-center" style="color:gray">주소</td>
				<td width="60%">${vo.address }</td>
			</tr>
			<tr>
				<td width="10%" class="text-center" style="color:gray">주차</td>
				<td width="60%">${vo.parking }</td>
			</tr>
			<tr>
				<td width="10%" class="text-center" style="color:gray">영업시간</td>
				<td width="60%">${vo.time }</td>
			</tr>
			<tr>
				<td width="10%" class="text-center" style="color:gray">테마</td>
				<td width="60%">${vo.theme }</td>
			</tr>
			<tr>
				<td width="10%" class="text-center" style="color:gray">가격</td>
