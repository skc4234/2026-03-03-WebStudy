			...
			<tbody>
				...
				<tr>
					<td colspan="3" class="text-right">
						<button type="button" class="btn btn-sm btn-danger">좋아요</button>
						<button type="button" class="btn btn-sm btn-info">찜하기</button>
						<button type="button" class="btn btn-sm btn-success">예약하기</button>
						<button type="button" class="btn btn-sm btn-warning" onclick="javascript:history.back()">목록</button>
					</td>
				</tr>
			</tbody>
		</table>
...
<script>
	let detail=Vue.createApp({
		data(){
			return {
				no:${param.no}, // request.getParameter("no")
				food_detail:{} // => 데이터가 갱신되는 경우 HTML에 적용
			}
		},
		mounted(){
		...
		methods:{
			addScript(){
				...
				script.src="http://dapi.kakao.com/v2/maps/sdk.js?autoload=false&appkey=e233f3fb087bf12a75b220e708b1e9ca&libraries=services"
